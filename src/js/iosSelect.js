...
(function() {
	...
	function IosSelect(level, data, options) {
		...
		//滚动选择结束时回调
		this.scrollOneEndCB = options.scrollOneEndCB || null;
		this.scrollTwoEndCB = options.scrollTwoEndCB || null;
		this.scrollThreeEndCB = options.scrollThreeEndCB || null;
		this.scrollFourEndCB = options.scrollFourEndCB || null;
		this.scrollFiveEndCB = options.scrollFiveEndCB || null;
		this.options.mainTitle =  options.mainTitle || '';
		this.options.subTitle =  options.subTitle || '';
		this.options.title1 = options.title1 || '';
		this.options.title2 = options.title2 || '';
		this.options.title3 = options.title3 || '';
		this.options.title4 = options.title4 || '';
		this.options.title5 = options.title5 || '';
		this.options.itemHeight = options.itemHeight || 35;
		this.options.sureBtnTxt = options.sureBtnTxt || '确定';
		this.options.closeBtnTxt = options.closeBtnTxt || '取消';
		...
		this.options.titleHeight = options.titleHeight || 0;
		this.options.headerHeight = options.headerHeight || 44;
		this.options.footerHeight = options.footerHeight || 44;
	...
	IosSelect.prototype = {
		...
		initLayer: function() {
			var self = this;
			var all_html = [
				'<div class="iosselect-title" style="height: ' + this.options.titleHeight + this.options.cssUnit + '">',
				'<span class="main-title">'+ this.options.mainTitle +'</span><span class="sub-title">'+ this.options.subTitle +'</span>',
				'</div>',
				'<header class="clearfix" style="height: ' + this.options.headerHeight + this.options.cssUnit + '; line-height: ' + this.options.headerHeight + this.options.cssUnit + '" class="iosselect-header"><!--',
					this.options.title1=='' ? '' : '--><h2 id="iosSelectTitle1" class="one-level"></h2><!--',
					this.options.title2=='' ? '' : '--><h2 id="iosSelectTitle2" class="two-level"></h2><!--',
					this.options.title3=='' ? '' : '--><h2 id="iosSelectTitle3" class="three-level"></h2><!--',
					this.options.title4=='' ? '' : '--><h2 id="iosSelectTitle4" class="four-level"></h2><!--',
					this.options.title5=='' ? '' : '--><h2 id="iosSelectTitle5" class="five-level"></h2><!--',
				'--></header>',
				...
				'</div>',
				'<div class="footer-btns" style="height: ' + this.options.footerHeight + this.options.cssUnit + '">',
					'<div class="footer-inner">',
						'<a href="javascript:void(0)" class="close-btn close">'+this.options.closeBtnTxt+'</a>',
						'<a href="javascript:void(0)" class="sure-btn sure">'+this.options.sureBtnTxt+'</a>',
					'</div>',
				'</div>'
			...
			this.iosSelectTitle1Dom = this.iosSelectLayer.el.querySelector('#iosSelectTitle1');
			this.iosSelectTitle2Dom = this.iosSelectLayer.el.querySelector('#iosSelectTitle2');
			this.iosSelectTitle3Dom = this.iosSelectLayer.el.querySelector('#iosSelectTitle3');
			this.iosSelectTitle4Dom = this.iosSelectLayer.el.querySelector('#iosSelectTitle4');
			this.iosSelectTitle5Dom = this.iosSelectLayer.el.querySelector('#iosSelectTitle5');

			this.iosSelectLoadingBoxDom = this.iosSelectLayer.el.querySelector('#iosSelectLoadingBox');
			if (this.options.title1) {
				this.iosSelectTitle1Dom.innerHTML = this.options.title1;
			}
			if (this.options.title2) {
				this.iosSelectTitle2Dom.innerHTML = this.options.title2;
			}
			if (this.options.title3) {
				this.iosSelectTitle3Dom.innerHTML = this.options.title3;
			}
			if (this.options.title4) {
				this.iosSelectTitle4Dom.innerHTML = this.options.title4;
			}
			if (this.options.title5) {
				this.iosSelectTitle5Dom.innerHTML = this.options.title5;
			}

			if (this.options.headerHeight && this.options.itemHeight) {
				this.coverArea1Dom = this.iosSelectLayer.el.querySelector('.cover-area1');
				this.coverArea1Dom.style.top = this.options.titleHeight + this.options.headerHeight + this.options.itemHeight * this.options.coverArea1Top + this.options.cssUnit;

				this.coverArea2Dom = this.iosSelectLayer.el.querySelector('.cover-area2');
				this.coverArea2Dom.style.top = this.options.titleHeight + this.options.headerHeight + this.options.itemHeight * this.options.coverArea2Top + this.options.cssUnit;
			}
			...
			this.iosSelectLayer.el.querySelector('.layer').style.height = this.options.itemHeight * this.options.itemShowCount + this.options.titleHeight + this.options.headerHeight + this.options.footerHeight + this.options.cssUnit;
			...
			this.scrollOne.on('scrollEnd', function() {
				...
				//滚动选择结束时回调
				self.scrollOneEndCB && self.scrollOneEndCB(self.selectOneObj, self.selectTwoObj, self.selectThreeObj, self.selectFourObj, self.selectFiveObj);
			});
			...
			if (this.level >= 2) {
				...
				this.scrollTwo.on('scrollEnd', function() {
					...
					//滚动选择结束时回调
					self.scrollTwoEndCB && self.scrollTwoEndCB(self.selectOneObj, self.selectTwoObj, self.selectThreeObj, self.selectFourObj, self.selectFiveObj);
			...
			if (this.level >= 3) {
				...
				this.scrollThree.on('scrollEnd', function() {
					...
					//滚动选择结束时回调
					self.scrollThreeEndCB && self.scrollThreeEndCB(self.selectOneObj, self.selectTwoObj, self.selectThreeObj, self.selectFourObj, self.selectFiveObj);
			...
			if (this.level >= 4) {
				...
				this.scrollFour.on('scrollEnd', function() {
					...
					//滚动选择结束时回调
					self.scrollFourEndCB && self.scrollFourEndCB(self.selectOneObj, self.selectTwoObj, self.selectThreeObj, self.selectFourObj, self.selectFiveObj);
			...
			if (this.level >= 5) {
				...
				this.scrollFive.on('scrollEnd', function() {
					...
					//滚动选择结束时回调
					self.scrollFiveEndCB && self.scrollFiveEndCB(self.selectOneObj, self.selectTwoObj, self.selectThreeObj, self.selectFourObj, self.selectFiveObj);
		...
		renderOneLevel: function(oneLevelId, twoLevelId, threeLevelId, fourLevelId, fiveLevelId, oneLevelData) {
			...
			var _that = this;
			$(this.oneLevelUlContainDom).find('li').each(function(idx, el){
				$(el).on('click', function(e){
					_that.scrollOne.scrollToElement('li:nth-child(' + ($(e.target).index()-(Math.floor(_that.options.itemShowCount/2)-1)) + ')', 500);
				});
			});
		...
		renderTwoLevel: function(oneLevelId, twoLevelId, threeLevelId, fourLevelId, fiveLevelId, twoLevelData) {
			...
			var _that = this;
			$(this.twoLevelUlContainDom).find('li').each(function(idx, el){
				$(el).on('click', function(e){
					_that.scrollTwo.scrollToElement(':nth-child(' + ($(e.target).index()-(Math.floor(_that.options.itemShowCount/2)-1)) + ')', 500);
				});
			});
		},
	    ...
	    renderThreeLevel: function(oneLevelId, twoLevelId, threeLevelId, fourLevelId, fiveLevelId, threeLevelData) {
			...
			var _that = this;
			$(this.threeLevelContainDom).find('li').each(function(idx, el){
				$(el).on('click', function(e){
					_that.scrollThree.scrollToElement(':nth-child(' + ($(e.target).index()-(Math.floor(_that.options.itemShowCount/2)-1)) + ')', 500);
				});
			});
	    },
	    ...
	    renderFourLevel: function(oneLevelId, twoLevelId, threeLevelId, fourLevelId, fiveLevelId, fourLevelData) {
			...
			var _that = this;
			$(this.fourLevelUlContainDom).find('li').each(function(idx, el){
				$(el).on('click', function(e){
					_that.scrollFour.scrollToElement(':nth-child(' + ($(e.target).index()-(Math.floor(_that.options.itemShowCount/2)-1)) + ')', 500);
				});
			});
	    },
	    ...
	    renderFiveLevel: function(oneLevelId, twoLevelId, threeLevelId, fourLevelId, fiveLevelId, fiveLevelData) {
			...
			var _that = this;
			$(this.fiveLevelUlContainDom).find('li').each(function(idx, el){
				$(el).on('click', function(e){
					_that.scrollFive.scrollToElement(':nth-child(' + ($(e.target).index()-(Math.floor(_that.options.itemShowCount/2)-1)) + ')', 500);
				});
			});
	    },
